...
// SVG REMOVE AND COMPLETE ICONS ELEMENTS
...
function completeItem() {
	...
	// checking if target has to be added to completed list or  
	// if it has to be added back to the todo list
...
// add new items to our to-do list
